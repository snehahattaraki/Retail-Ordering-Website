...
namespace Retail_booking.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "BrandId", "CategoryId", "Description", "ImageUrl", "Name", "PackagingId", "Price", "StockQty" },
                values: new object[,]
                {
                    { 1, 1, 1, "Classic pizza", null, "Margherita Pizza", 1, 9.99m, 10 },
                    { 2, 1, 2, "Cold drink", null, "Coke", 1, 1.99m, 50 }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "Name", "PasswordHash", "RoleId" },
                values: new object[] { 1, "admin@retail.com", "Admin", "$2a$11$fEQTn/ktJr4ffwPaxbg5zejNdroN87zPG6zASG5Ci3gaLeRCV2dxe", 1 });
